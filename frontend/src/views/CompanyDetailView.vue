...
const tabs = [
  { key: 'info', label: 'Info' },
  { key: 'calls', label: 'História hovorov' },
  { key: 'notes', label: 'Poznámky' },
  { key: 'audit', label: 'História zmien' },
] as const;
</script>
  ...
  <DashboardShell>
    ...
    <template v-else-if="company">
      ...
      <div v-if="activeTab === 'calls'">
        <div class="card">
          <h3 class="text-lg font-semibold mb-4">História hovorov</h3>
            ...
            >
              <div class="flex-1">
                <div class="flex items-center gap-2 mb-1">
                  ...
                  <span class="text-sm text-gray-400">{{ log.salesmanName }}</span>
                </div>
